...
- Next action: Continue semantic-atomicity and source-fidelity review across the remaining represented operator-facing provisions, then obtain specialist legal review before treating the current operator-focused article decomposition as a complete legal corpus.
...
| `EXTREQ-02D3C38E60FBC75C` | Article 9(5) | When eliminating or reducing use-related risks, give due consideration to expected deployer technical knowledge, experience, education and training and the presumable context of use. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-02F4CC772D68FDC5` | Article 9(6) | Test the high-risk AI system to identify the most appropriate and targeted risk management measures. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-0348B64AA2D82BC9` | Article 12(2)(c) | Enable logs to record events relevant to monitoring operation of the high-risk AI systems referred to in Article 26(5). | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-0544CA2011844D7B` | Article 9(2)(b) | Estimate and evaluate risks that may emerge under intended use and reasonably foreseeable misuse. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-06DFAE509FD6D2C0` | Article 11(3) | The Commission may amend Annex IV by delegated act where necessary so that, in light of technical progress, technical documentation continues to provide all information needed to assess compliance with Section 2. | `mandatory-normative` / `permission` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-132DED975A441336` | Article 15(1) | Design and develop high-risk AI systems to achieve appropriate accuracy, robustness and cybersecurity and to perform consistently in those respects throughout their lifecycle. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-1736F5D9A9FEE3E6` | Article 4a(1)(e) | Delete the special-category personal data when the bias has been corrected or when the applicable retention period ends, whichever occurs first. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-178652263E9E4A18` | Article 10(3) | Ensure the data sets are sufficiently representative in view of the intended purpose. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-181639FC9C3F5A1B` | Article 13(3)(e) | Include the expected lifetime of the high-risk AI system. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-194BAA01C8CEDF96` | Article 4a(2)(b) | When processing special-category personal data under Article 4a(2), apply all conditions and safeguards set out in Article 4a(1). | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-1AB25504326527DA` | Article 11(2) | For a high-risk AI system related to a product covered by Annex I Section A Union harmonisation legislation, draw up a single technical-documentation set containing both Article 11(1) information and the information required by that legislation. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-1B96234907248707` | Article 9(2)(c) | Evaluate other risks that may arise based on analysis of data gathered through the Article 72 post-market monitoring system. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-20379EF0C7E97FDF` | Article 12(3)(a) | For Annex III point 1(a) high-risk AI systems, record the start and end date and time of each use. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-20A358942F546D98` | Article 4a(1)(d) | Do not transmit or transfer the special-category personal data, or otherwise make it accessible, to other parties. | `mandatory-normative` / `prohibition` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-22BDBAD2AF63385B` | Article 13(3)(a) | Include in the instructions for use the identity and contact details of the provider and, where applicable, its authorised representative. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-2367DE2925863585` | Article 13(3)(b)(vi) | When appropriate, include specifications for input data or other relevant information about the training, validation and testing data sets used, taking account of the intended purpose. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-24BC7F6212EFE2B0` | Article 13(1) | Design and develop the high-risk AI system with sufficient operational transparency to enable deployers to interpret its output and use it appropriately, at a type and degree that supports compliance with the relevant provider and deployer obligations in Section 3. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-268ED9A986D7E83B` | Article 13(3)(b)(ii) | Include the tested and validated levels and metrics for accuracy, robustness and cybersecurity that can be expected, together with known and foreseeable circumstances that may affect those expected levels. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-2946FBD35BC58A58` | Article 9(1) | Establish, implement, document and maintain a risk management system for each high-risk AI system. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-299CB405AFD073AD` | Article 9(2)(a) | Identify and analyse known and reasonably foreseeable health, safety and fundamental-rights risks arising when the high-risk AI system is used as intended. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-2D5184C0CBC7C888` | Article 9(8) | Perform testing, as appropriate, at relevant times throughout the development process. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-3398AE5CB3D99116` | Article 10(4) | Ensure data sets take account, to the extent required by the intended purpose, of characteristics particular to the geographical, contextual, behavioural or functional setting in which the high-risk AI system is intended to be used. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-33D39FEAEBDBD160` | Article 9(9) | When implementing the Article 9(1)-(7) risk management system, consider whether the intended-purpose use of the high-risk AI system is likely to adversely affect persons under 18 and, where appropriate, other vulnerable groups. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-34D794BAE48B2042` | Article 4a(2)(a) | Providers and deployers of other AI systems and models, and deployers of high-risk AI systems, may exceptionally process special categories of personal data only where strictly necessary for bias detection and correction concerning the specified health, safety, fundamental-rights or prohibited-discrimination risks. | `permitted-optional` / `permission` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-38FC055E070AEFB7` | Article 14(4)(b) | Enable assigned overseers, as appropriate and proportionate, to remain aware of the risk of automatically relying or over-relying on system output, particularly where the system informs or recommends human decisions. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-3A41A9530EB9DEB2` | Article 4a(1)(a) | Before relying on the Article 4a(1) permission, establish that bias detection and correction cannot be effectively fulfilled by processing other data, including synthetic or anonymised data. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-3E52DB8E6BE507D2` | Article 9(5)(a) | Eliminate or reduce identified and evaluated risks as far as technically feasible through adequate design and development of the high-risk AI system. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-3E93785343DE869B` | Article 9(6) | Use testing to ensure the high-risk AI system performs consistently for its intended purpose. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-42D3F017A9786AE8` | Article 12(1) | Design high-risk AI systems to technically allow automatic recording of events (logs) throughout the system lifetime. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-4B0FECC5888FA820` | Article 12(3)(d) | For Annex III point 1(a) high-risk AI systems, record the identity of the natural persons involved in verification of results under Article 14(5). | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-4C363481F7EA7361` | Article 15(5) | Ensure technical cybersecurity solutions are appropriate to the relevant circumstances and risks. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-5726BF6006EBDB6B` | Article 9(8) | In all cases, perform testing before the high-risk AI system is placed on the market or put into service. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-602304871330447F` | Article 14(4)(c) | Enable assigned overseers, as appropriate and proportionate, to correctly interpret system output using available interpretation tools and methods. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-60CACACB2BFEB7F7` | Article 9(7) | Testing procedures may include testing in real-world conditions in accordance with Article 60. | `permitted-optional` / `permission` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-614B18BB6F06157D` | Article 15(3) | Declare the levels of accuracy and relevant accuracy metrics of the high-risk AI system in the accompanying instructions for use. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-6346DFE636508217` | Article 11(1) | A qualifying SME, start-up or SMC that chooses simplified Annex IV documentation must use the Commission's simplified technical-documentation form. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-63C7B2C7A40C2498` | Article 10(1) | Where a high-risk AI system uses techniques involving training AI models with data, develop it on training, validation and testing data sets that satisfy the applicable quality criteria in Article 10(2)-(4) and the cross-referenced conditions in Article 4a(1). | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-665D430E7172E64F` | Article 4a(1) | A provider of a high-risk AI system may exceptionally process special categories of personal data only to the extent strictly necessary for bias detection and correction under Article 10(2)(f) and (g), subject to appropriate fundamental-rights safeguards and all Article 4a(1) conditions. | `permitted-optional` / `permission` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-67532161EDB6C017` | Article 13(3)(b)(v) | When appropriate, include the high-risk AI system's performance regarding specific persons or groups on which it is intended to be used. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-7234C42AA78CCF38` | Article 10(3) | Ensure the data sets are relevant in view of the intended purpose. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-73A86024AF7D7161` | Article 9(5)(b) | Where appropriate, implement adequate mitigation and control measures for risks that cannot be eliminated. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-75628AD3ADD38906` | Article 9(2) | Plan and run risk management as a continuous iterative process throughout the high-risk AI system lifecycle, with regular systematic review and updating. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-7D000D6868EDE244` | Article 11(1) | Establish a simplified technical-documentation form targeted to the needs of SMEs, including start-ups, and SMCs. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-8406A6A9A7ECFCB6` | Article 4a(1)(c) | Secure and protect the special-category personal data with suitable safeguards, including strict access controls and access documentation, and restrict access to authorised persons subject to appropriate confidentiality obligations. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-889248600BFC9D01` | Article 13(3)(d) | Include the human-oversight measures referred to in Article 14, including technical measures that facilitate deployer interpretation of outputs. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-89DCF5FABCA6D7EC` | Article 13(3)(b)(iii) | Include known or foreseeable circumstances of intended use or reasonably foreseeable misuse that may lead to health, safety or fundamental-rights risks referred to in Article 9(2). | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-8B44F849EE874DDD` | Article 9(8) | Carry out testing against prior-defined metrics and probabilistic thresholds appropriate to the intended purpose of the high-risk AI system. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-8E81789B79DB8954` | Article 11(1) | Include at least the elements specified in Annex IV in the technical documentation. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-8EFA5B7D3F8BBDD6` | Article 14(4)(a) | Enable assigned overseers, as appropriate and proportionate, to understand relevant system capabilities and limitations and duly monitor operation, including detecting and addressing anomalies, dysfunctions and unexpected performance. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-8F7449E24AFD2A1B` | Article 13(3)(e) | Include the computational and hardware resources needed for the high-risk AI system. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-90A317D512B165D5` | Article 12(2) | Provide logging capabilities that support a level of traceability of system functioning appropriate to the intended purpose. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-9116B07FC5232868` | Article 14(2) | Structure human oversight to prevent or minimise health, safety and fundamental-rights risks arising under intended use or reasonably foreseeable misuse, particularly residual risks remaining after other Section 2 controls. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-9222332544520C5A` | Article 10(2)(h) | Identify relevant data gaps or shortcomings that prevent compliance with the Regulation and determine how they can be addressed. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-92B09762EF226E56` | Article 13(3)(e) | Include necessary maintenance and care measures, including their frequency, needed to ensure proper functioning of the high-risk AI system, including software updates. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-93622681B6244218` | Article 10(2)(a) | Ensure the data-governance and management practices address relevant design choices. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-93CCE5CD38E0051D` | Article 11(1) | SMEs, including start-ups, and SMCs may provide the Annex IV technical-documentation elements in the simplified manner established for them. | `mandatory-normative` / `permission` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-9DF571A09E1A27D1` | Article 10(2)(b) | Ensure the practices address data-collection processes and data origin, and for personal data the original purpose of collection. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-9E58A53D9E4E7141` | Article 13(3)(b)(iv) | Where applicable, include technical capabilities and characteristics that provide information relevant to explaining the high-risk AI system's output. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-9FE3860DE191D68F` | Article 11(1) | Notified bodies must accept the simplified technical-documentation form for conformity-assessment purposes. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-9FEBFF29B834BD4C` | Article 10(2)(e) | Assess the availability, quantity and suitability of the data sets needed for the high-risk AI system. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-A24734AAA7BA537F` | Article 12(3)(b) | For Annex III point 1(a) high-risk AI systems, record the reference database against which system input data was checked. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-A413FEA840F110E8` | Article 14(1) | Design and develop high-risk AI systems, including with appropriate human-machine interface tools, so natural persons can effectively oversee them while in use. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-A41CA145D8369351` | Article 13(3)(c) | Include any provider-predetermined changes to the high-risk AI system and its performance identified at the initial conformity assessment. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-A683139A9E6FCED0` | Article 11(1) | Prepare technical documentation so it demonstrates compliance with Section 2 and gives national competent authorities and notified bodies the necessary clear and comprehensive information to assess compliance. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-A8967B5D4698D35E` | Article 12(3)(c) | For Annex III point 1(a) high-risk AI systems, record the input data for which a search produced a match. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-AC83782B40495818` | Article 9(6) | Use testing to ensure the high-risk AI system complies with the requirements in Chapter III Section 2. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-B0A987917989EBD3` | Article 9(5)(c) | Provide the information required by Article 13 and, where appropriate, training to deployers as part of risk management. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-B28452CC09682655` | Article 10(2) | Subject training, validation and testing data sets to data-governance and management practices that are appropriate for the intended purpose of the high-risk AI system. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-B40880CAC2A2BE26` | Article 15(2) | The Commission must, in cooperation with relevant stakeholders and organisations, encourage as appropriate the development of benchmarks and measurement methodologies for appropriate accuracy, robustness and other relevant performance metrics. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-B9775B02872296D0` | Article 14(3)(a) | When technically feasible, identify and build appropriate human-oversight measures into the high-risk AI system before market placement or putting into service. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-BAA343B6CDB1862E` | Article 14(5) | For Annex III point 1(a) high-risk AI systems, ensure no deployer action or decision is based on system identification unless at least two competent, trained and authorised natural persons separately verify and confirm that identification. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-BC555C025ADA13E7` | Article 10(2)(c) | Ensure the practices address relevant data-preparation processing operations. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-BD2D919253BF3CDC` | Article 15(4) | Make high-risk AI systems as resilient as possible to errors, faults or inconsistencies arising within the system or its operating environment, including through interaction with natural persons or other systems, and take technical and organisational measures accordingly. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-BEACEB7A006E67C6` | Article 12(2)(b) | Enable logs to record events relevant to facilitating Article 72 post-market monitoring. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-C12EF9A1F6B7F76A` | Article 14(4)(d) | Enable assigned overseers, as appropriate and proportionate, to decide not to use the system or to disregard, override or reverse its output in a particular situation. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-C5F70A760221CB4E` | Article 13(2) | Accompany the high-risk AI system with instructions for use, in an appropriate digital format or otherwise, that satisfy the source-defined information-quality and usability criteria for deployers. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-CA7D139554BB327C` | Article 9(4) | When selecting risk management measures, consider effects and interactions from the combined application of Section 2 requirements so risks are minimised effectively while implementation remains appropriately balanced. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-CA7D89D6C27E1B66` | Article 4a(1)(b) | Apply technical limitations on re-use of the special-category personal data and state-of-the-art security and privacy-preserving measures, including pseudonymisation. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-CBD23444D45C0CED` | Article 11(1) | Keep the technical documentation for the high-risk AI system up to date. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-CC21D20CF04D712A` | Article 14(3) | Make human-oversight measures commensurate with the high-risk AI system's risks, level of autonomy and context of use. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-CF0A4B23B3BA8520` | Article 9(2)(d) | Adopt appropriate and targeted risk management measures addressing the risks identified under Article 9(2)(a). | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-D00F7CC23DF9821F` | Article 10(3) | Ensure the data sets are, to the best extent possible, complete in view of the intended purpose. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-D8E5BC29A4B8D257` | Article 12(2)(a) | Enable logs to record events relevant to identifying situations that may result in a risk under Article 79(1) or a substantial modification. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-DCA23E99AFB9D80B` | Article 10(3) | Ensure the data sets are, to the best extent possible, free of errors in view of the intended purpose. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-DE5117D6C579F0C0` | Article 9(5) | Ensure the overall residual risk of the high-risk AI system is judged acceptable. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-DEA2B22466A64818` | Article 14(4)(e) | Enable assigned overseers, as appropriate and proportionate, to intervene in operation or interrupt the system through a stop mechanism or similar procedure that brings it to a safe state. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-E07756B983D5575E` | Article 13(3)(f) | Where relevant, include a description of mechanisms in the high-risk AI system that enable deployers to properly collect, store and interpret logs in accordance with Article 12. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-E7072B9D822AE4CC` | Article 14(3)(b) | Before market placement or putting into service, identify human-oversight measures appropriate for implementation by the deployer. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-E732321E515FACD8` | Article 9(10) | A provider already subject to internal risk-management requirements under other relevant Union law may include or combine Article 9(1)-(9) aspects within those existing risk-management procedures. | `permitted-optional` / `permission` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-E9AA611B0FEEA58B` | Article 9(5) | Ensure the relevant residual risk associated with each hazard is judged acceptable. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-EB9B6D8D8679CECC` | Article 15(4) | Technical redundancy, including backup or fail-safe plans, may be used to achieve robustness of high-risk AI systems. | `mandatory-normative` / `permission` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-EBE6DC949B6FC20A` | Article 10(2)(f) | Examine data sets for possible biases likely to affect health or safety, negatively affect fundamental rights, or lead to discrimination prohibited under Union law, including feedback-loop risks. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-ED132C75DBBFFA1A` | Article 15(5) | Make high-risk AI systems resilient against attempts by unauthorised third parties to alter system use, outputs or performance by exploiting vulnerabilities. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-EF7A17795274F23D` | Article 15(4) | For high-risk AI systems that continue learning after market placement or putting into service, eliminate or reduce as far as possible the risk that biased outputs influence future inputs and address resulting feedback loops with appropriate mitigation measures. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-F5D35DE8FBA32DFA` | Article 13(3)(b)(i) | Include the high-risk AI system's intended purpose in the instructions for use. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-F682BB69E2356482` | Article 13(3)(b)(vii) | Where applicable, include information enabling deployers to interpret the high-risk AI system's output and use it appropriately. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-F7A7DA9DCA8D32BD` | Article 4a(1)(f) | Record why processing special-category personal data was strictly necessary for bias detection and correction and why the objective could not be achieved by processing other data. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-F8090209290ACA6B` | Article 15(5) | Where appropriate, include technical measures to prevent, detect, respond to, resolve and control AI-specific attacks and vulnerabilities, including data or model poisoning, adversarial examples or model evasion, confidentiality attacks and model flaws. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-FDA81C83E36C9487` | Article 10(2)(d) | Ensure the practices address assumptions about the information the data are intended to measure and represent. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-FE0BA141D12895DA` | Article 11(1) | Draw up technical documentation for the high-risk AI system before it is placed on the market or put into service. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
| `EXTREQ-FE2859AF565EC65F` | Article 10(2)(g) | Take appropriate measures to detect, prevent and mitigate possible biases identified under Article 10(2)(f). | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-FF6802300FFACB68` | Article 10(3) | Ensure the data sets have appropriate statistical properties, including where applicable for persons or groups on whom the high-risk AI system is intended to be used. | `mandatory-normative` / `positive-duty` | `binding-law` | `compliance` | `reviewed-analytical-summary` / `direct-public-primary` |
...
| `EXTREQ-09AC3C68DD3B9DA0` | 6.1(d) | Provide an operational capability to moderate ASOI behavior to preserve freedom from unacceptable risk of harm. | `mandatory-normative` / `positive-duty` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-1D3ECE3F78BA0638` | 8.3 DIOP2 | Detect behavioral anomalies and verify specified ASOI behaviors. | `mandatory-normative` / `positive-duty` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-2E3CBE869A1E2400` | 8.3 DIOP6 | Evaluate whether freedom from unacceptable risk of harm is acceptable and decide whether to request continued execution. | `mandatory-normative` / `positive-duty` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-4A98B446C4E83ECE` | 8.3 DIOP4 | Identify, select and initiate moderating responses, evaluate the resulting safety state, report deviations and decide whether to request continued execution. | `mandatory-normative` / `positive-duty` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-81F4A4D7227B1970` | 8.3 DIOP3 | Diagnose risk-significant behavioral anomalies, determine root cause, confidence, criticality and a recovery target, report the diagnostic results and request continued execution. | `mandatory-normative` / `positive-duty` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
| `EXTREQ-8204FA30873DD481` | 6.1(a) | Provide an operational capability to monitor ASOI behavior. | `mandatory-normative` / `positive-duty` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-95307E8CDBC1B4BE` | 6.1(c) | Provide an operational capability to identify anomalous ASOI behavior that may cause loss of freedom from unacceptable risk of harm. | `mandatory-normative` / `positive-duty` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-D400D6712209533C` | 8.3 DIOP5 | Identify, select and initiate behavioral modifications, evaluate whether the resulting safety state is acceptable and decide whether to request continued execution. | `mandatory-normative` / `positive-duty` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-034A4E4BE4256FEA` | 4.2.4.2(h-j) | Provide qualified human oversight, subject calibration, and a competent representative where a subject may lack adequate mental capacity. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
| `EXTREQ-0B2020DA20A3C58F` | 4.2.5.2(f-g) | Include contextual factors in system functioning and adapt to contextual variations that can affect affective interpretation and interaction. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-0F01A1CB6689A29C` | 4.2.3.2(i) | Publish explanations of system capabilities and limitations, data, inputs and outputs, transformations, purpose fit, theoretical frameworks, affective models, and decision rationale. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
| `EXTREQ-165B1E14832D03BB` | 4.3.6.2(e-g) | Use qualified third-party assessment and auditing, monitor as close to real time as feasible, and provide human oversight and intervention where required. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
| `EXTREQ-207DF29B90342D64` | 4.2.4.2(f-g) | Give subjects controls over data processing and system intervention and facilities to access and securely share inferences and decisions made about them. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
| `EXTREQ-232C1E944C64A096` | 4.3.4.2(d-e) | Use high-quality recognized third-party affective datasets and multiple data modes when doing so is likely to improve system quality and robustness. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-257E52610866FCC5` | 4.2.6.1(f) | Account for adaptive learning and training in quality assurance and monitor the EA/IS after it enters production. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
| `EXTREQ-25F7FDBCB05167F6` | 4.1.1.2(c-d) | Maintain continuing education on the wider empathic-AI context and foster continuous learning and collaboration with specialists and affected stakeholders. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-3FAE7DFA860DDA3F` | 4.2.2.2(j) | Use a qualified third party for risk, issue and impact assessment where possible. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-49B20F7E12B92A09` | 4.3.2.2 (post-p) | Where possible, do not unduly withhold service solely because a subject chooses not to provide, or fails to provide, effective informed consent. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-591C687B7AAB1C42` | 4.2.2.2(k-m) | Personalize system behavior to subject circumstances and risk tolerance, help identify cognitive biases, and use human-like communication where possible to improve risk management. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-856A20AED8300290` | 4.3.1.2(d-f) | Give subjects primacy where possible, treat vulnerable parties as part of the default audience unless formally restricted otherwise, and apply a human-centered lifecycle approach. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
| `EXTREQ-88F3BD55BF1133E0` | 4.2.1.2(a-c) | Use a recognized well-being impact assessment process, assess stakeholder hierarchy conflicts, and use third-party assessment or peer review. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-A4C2C62D03C5A1E5` | 4.2.4.2(d-e) | Use diverse affective data sources and labels that accurately reflect the perspectives and experiences of the people who provided the data. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-B2D2AD80662D9F55` | 4.2.3.1 | As far as possible, make explainability documentation support replication of system outputs for testing by appropriate parties. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
| `EXTREQ-B5990D77382C145B` | 4.2.3.2(j) | Use ethical-explainability documentation to describe main design, build and operation approaches, their possible implications, and why each approach is ethically justified. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-E1192EA0D6788B46` | 4.2.5.2(d-e) | Make reasonable efforts to identify, record and reduce potential bias and use methods or tools for checking and mitigating bias. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
...
| `EXTREQ-FF2403085993AD8A` | 4.3.5.2 (post-f) | Where possible, let subjects calibrate the degree of intimacy and obtrusiveness of system behavior. | `recommended-practice` / `guidance` | `voluntary-consensus-standard` | `conformance` | `reviewed-analytical-summary` / `direct-licensed-primary` |
