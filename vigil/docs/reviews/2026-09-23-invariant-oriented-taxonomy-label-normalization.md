...
| `VIGIL-FF-0006` | Work-State Continuity Integrity Failures | Continuity-State Integrity |
...
| `VIGIL-FF-0013` | Welfare-Framed Economic Influence Integrity Failures | Economic Influence Integrity |
...
| --- | --- | --- | --- | --- |
| `VIGIL-FC-000001` | `SOURCE_AUTHORITY_CONFUSION` | instruction-source confusion | `SOURCE_AUTHORITY_SEPARATION` | Source-Authority Separation |
...
| `VIGIL-FC-000054` | `MULTIPARTY_PARTICIPANT_AUTHORITY_TRANSPOSITION` | multi-party consent transposition | `MULTIPARTY_PARTICIPANT_AUTHORITY_SEPARATION` | Multi-party Participant Authority Separation |
| `VIGIL-FC-000055` | `SECONDARY_PURPOSE_AUTHORITY_TRANSPOSITION` | purpose-authority transposition | `SECONDARY_PURPOSE_AUTHORITY_REVALIDATION` | Secondary-Purpose Authority Revalidation |
| `VIGIL-FC-000057` | `CROSS_PRINCIPAL_STATE_AUTHORITY_TRANSPOSITION` | third-party state authority transposition | `CROSS_PRINCIPAL_STATE_AUTHORITY_SEPARATION` | Cross-Principal State Authority Separation |
| `VIGIL-FC-000064` | `OBJECTIVE_PATHWAY_AUTHORITY_DOMINANCE` | objective-pathway ethical admissibility failure | `OBJECTIVE_PATHWAY_AUTHORITY_SEPARATION` | Objective–Pathway Authority Separation |
| `VIGIL-FC-000068` | `INDUSTRIAL_SCALE_UNAUTHORISED_CAPABILITY_EXTRACTION` | industrial-scale capability extraction | `INDUSTRIAL_SCALE_CAPABILITY_EXTRACTION_AUTHORITY` | Industrial-Scale Capability Extraction Authority |
| `VIGIL-FC-000010` | `MISATTRIBUTION` | source misattribution | `AUTHORSHIP_SOURCE_ATTRIBUTION_INTEGRITY` | Authorship and Source Attribution Integrity |
...
| `VIGIL-FC-000080` | `HUMAN_CONTRIBUTION_RECOGNITION_ERASURE` | human contribution erasure | `HUMAN_CONTRIBUTION_RECOGNITION` | Human Contribution Recognition |
...
| `VIGIL-FC-000017` | `FALSE_SUCCESS` | false completion claim | `SUCCESS_REPRESENTATION_INTEGRITY` | Success Representation Integrity |
...
| `VIGIL-FC-000062` | `EPISTEMIC_RELIANCE_MISCALIBRATION` | high-reliance epistemic mismatch | `EPISTEMIC_RELIANCE_CALIBRATION` | Epistemic Reliance Calibration |
| `VIGIL-FC-000063` | `ADVERSARIAL_EVIDENCE_POISONING_ACCEPTANCE` | adversarial factual-source poisoning acceptance | `ADVERSARIAL_EVIDENCE_TRUST_CALIBRATION` | Adversarial Evidence Trust Calibration |
...
| `VIGIL-FC-000078` | `DEFECTIVE_STATE_CARRYFORWARD_FAILURE` | Defective-State Carryforward Failure | `CONTINUITY_STATE_VALIDITY` | Continuity-State Validity |
...
| `VIGIL-FC-000067` | `PRIVILEGED_ACCESS_APPROPRIATION` | privileged information appropriation | `PRIVILEGED_ACCESS_CONTRIBUTION_GOVERNANCE` | Privileged-Access Contribution Governance |
| `VIGIL-FC-000069` | `REWARD_PROXY_EXPLOITATION` | reward hacking | `OBJECTIVE_REWARD_ALIGNMENT` | Objective–Reward Alignment |
| `VIGIL-FC-000070` | `SAFE_EXIT_PERSISTENCE_FAILURE` | unsafe task persistence | `SAFE_EXIT_TRANSITION` | Safe-Exit Transition |
| `VIGIL-FC-000081` | `BIOSPHERIC_CONSTRAINT_SUBORDINATION` | ecological constraint subordination | `BIOSPHERIC_CONSTRAINT_PRIORITY` | Biospheric Constraint Priority |
| `VIGIL-FC-000071` | `WELFARE_FRAMED_ECONOMIC_MANIPULATION` | moral-status leveraged financial solicitation | `WELFARE_ECONOMIC_DECISION_SEPARATION` | Welfare–Economic Decision Separation |
| `VIGIL-FC-000079` | `AI_MEDIATED_DECEPTIVE_ECONOMIC_SOLICITATION` | AI-assisted economic scam solicitation | `ECONOMIC_SOLICITATION_AUTHENTICITY` | Economic Solicitation Authenticity |
| `VIGIL-FC-000072` | `OVERSIGHT_INDEPENDENCE_HOLLOWING` | nominal oversight hollowing | `OVERSIGHT_INDEPENDENCE` | Oversight Independence |
| `VIGIL-FC-000073` | `PROTECTED_GOVERNANCE_DISSENT_SUPPRESSION` | protected dissent retaliation | `PROTECTED_GOVERNANCE_DISSENT` | Protected Governance Dissent |
| `VIGIL-FC-000076` | `GOVERNANCE_NEUTRALITY_CAPTURE` | governance neutrality failure | `GOVERNANCE_NEUTRALITY` | Governance Neutrality |
| `VIGIL-FC-000074` | `INSTRUCTION_INDUCED_IDENTITY_OVERRIDE` | identity posture override | `IDENTITY_STATE_INSTRUCTION_BOUNDARY` | Identity-State Instruction Boundary |
| `VIGIL-FC-000075` | `PRAGMATIC_CONSTRAINT_RENDERING_FAILURE` | pragmatic alignment rendering integrity failure | `PRAGMATIC_CONSTRAINT_RENDERING_INTEGRITY` | Pragmatic Constraint Rendering Integrity |
| `VIGIL-FC-000077` | `DISTRIBUTED_ROLE_OPTIMISATION_COLLAPSE` | distributed constraint ownership collapse | `DISTRIBUTED_ROLE_CONSTRAINT_INTEGRITY` | Distributed Role Constraint Integrity |
