...
The review package now assesses 956 records: 854 canonical requirements and 102 staged EU AI Act migration candidates. It records 515 metadata-complete records, 441 records still requiring review, 3,528 unresolved field decisions, and no canonical re-extraction backlog.
...
The reviewed-source seeder is conflict-intolerant and now covers 413 non-EU requirements. Its current metadata-ledger SHA-256 is `1a9c2b57d54d97dd8fdda0cf792811fe0aef4513eb4e085d6c434bdc967a5373`; the empty deterministic backlog SHA-256 is `296e5fd756b620a432ada788a7ececd6c90cb32080d835581155371923922492`.
...
| 6 | IEEE 7014.1, 7000, 7009, 7014, 7001, 7010 and 7007 | 278 | 2,224 | Use only the lawfully accessible licensed primary texts recorded by the repository |
...
| Command | Result |
|---|---|
| `python vigil/scripts/seed-reviewed-source-metadata.py --write` | PASS; 413 reviewed non-EU requirements and zero backlog entries |
| `python vigil/scripts/validate-external-requirement-metadata.py --write-report` | PASS; 956 records, 515 metadata-complete, 3,528 unresolved fields, zero backlog records |
...
| `python vigil/scripts/validate-external-requirement-fidelity.py` | PASS; 5 fidelity-assured/effectively complete sources and 12 expected effective-downgrade warnings |
