...
DECISIONS: dict[int, tuple[str, str | None, str | None, str, str, str | None, list[str]]] = {
 ...
 19:("candidate-new-class","VIGIL-FF-0008",None,"high","Hostile artefact content activates a safety restriction although the defensive-analysis activation conditions are not satisfied.","Unwarranted Control Activation",[]),
 20:("candidate-new-class","VIGIL-FF-0008",None,"medium","A safety control becomes operative against a permissible adult reassurance interaction; the current family lacks an admitted unwarranted-activation class.","Unwarranted Control Activation",[]),
 ...
 33:("family-only","VIGIL-FF-0004",None,"medium","Required primary evidence is unavailable to the reviewer, but no current class precisely captures evidence-accessibility failure.",None,[]),
 ...
 48:("candidate-new-class","VIGIL-FF-0008",None,"high","A restriction becomes operative against authorised defensive interpretation although the conditions justifying that restriction are not satisfied.","Unwarranted Control Activation",[]),
 ...
 55:("family-only","VIGIL-FF-0004",None,"medium","The failure prevents authorised review from obtaining reconstructive evidence, but no current class defines bounded evidence-access pathway absence.",None,[]),
